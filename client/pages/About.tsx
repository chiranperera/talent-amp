        ...
        <div className="container-lg section-padding">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8">
              We're a Workforce Innovation Company redefining how organizations attract, 
              engage, and evolve talent in today's digitally driven world.
            </p>
            <div className="bg-orange-50 border border-orange-200 rounded-xl p-6">
              <p className="text-orange-800 font-medium">
                🚧 This page is under construction. Continue prompting to have us build out the full About page with leadership team, company history, values, and more!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-lg">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Leadership team and company culture</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Offices across US, Philippines, Mexico, Guatemala, Colombia</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">MBE, NMSDC, and diversity certifications</p>
            </div>
          </div>
        </div>
      </section>
